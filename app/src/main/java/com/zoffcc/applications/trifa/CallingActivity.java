...
public class CallingActivity extends AppCompatActivity implements CameraWrapper.CamOpenOverCallback, SensorEventListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (PREF__X_misc_button_enabled)
        {
            ...
            misc_button.setImageDrawable(getDrawable(R.drawable.ic_gravi_camera_flip));
                ...
                public boolean onTouch(View v, MotionEvent event)
                {
                    if (event.getAction() != MotionEvent.ACTION_UP)
                    {
                        try
                        {
                            ...
                            misc_button.setImageDrawable(getDrawable(R.drawable.ic_gravi_camera_flip_on));
                        }
                        catch (Exception e)
                        {
                            e.printStackTrace();
        ...
        mute_button.setImageDrawable(getDrawable(R.drawable.ic_gravi_micro));
        ...
        decline_button.setImageDrawable(getDrawable(R.drawable.ic_gravi_off_call));
        // #AARRGGBB
        ...
        accept_button.setImageDrawable(getDrawable(R.drawable.ic_gravi_on_call));
        ...
        if (active_camera_type == FRONT_CAMERA_USED)
        {
            final Drawable d5 = new IconicsDrawable(this).icon(GoogleMaterial.Icon.gmd_camera_front).backgroundColor(
                    Color.TRANSPARENT).color(getResources().getColor(R.color.colorPrimaryDark)).sizeDp(50);
            camera_toggle_button.setImageDrawable(getDrawable(R.drawable.ic_gravi_camera_flip));
        ...
        else
        {
            final Drawable d6 = new IconicsDrawable(this).icon(GoogleMaterial.Icon.gmd_camera_rear).backgroundColor(
                    Color.TRANSPARENT).color(getResources().getColor(R.color.colorPrimaryDark)).sizeDp(50);
            camera_toggle_button.setImageDrawable(getDrawable(R.drawable.ic_gravi_camera_flip_on));
